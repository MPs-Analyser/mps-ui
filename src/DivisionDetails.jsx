...
const DivisionDetails = ({ onQueryMp, division }) => {
  ...
  const NoRow = ({ index, style }) => (
    <li style={{ ...style, display: 'flex', alignItems: 'center', gap: 8 }}>
      ...
      />
      <a href='#' onClick={() => onQueryMp(votedNo[index].id)}>
  ...
  const AbsentRow = ({ index, style }) => (
    <li style={{ ...style, display: 'flex', alignItems: 'center', gap: 8 }}>
      ...
      />
      <a href='#' onClick={() => onQueryMp(absent[index].id)}>
    ...
    <div className="divisionDetails">
      ...
      {division && (
        <div className="divisionDetails__title">
          <div className="votingHistory__division-header" style={{ display: 'flex', gap: '.3em' }}>
          ...
          <div className="divisionDetails__date" style={{ display: 'flex', gap: '.3em', marginTop: '.5em' }}>
      ...
      <div className='ayesListWrapper' style={{ height: '100%', overflowX: 'hidden', display: 'flex', padding: '1em', overflow: 'hidden' }}>
