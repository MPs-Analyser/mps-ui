...
const DivisionDetails = ({ onQueryMp, division }) => {
  ...
  const [showAye, setShowAye] = React.useState(true);
  ...
  const AyeRow = ({ index, style }) => (
    <li className='divisionDetails__list-li' style={{ ...style }}>
      <PartyLogo
        partyName={votedAye[index]?.party}
      />
      <a href='#' className='plaintext' onClick={() => onQueryMp(votedAye[index].id)}>
  ...
  const NoRow = ({ index, style }) => (
    <li className='divisionDetails__list-li' style={{ ...style, display: 'flex', alignItems: 'center', gap: 8 }}>
      <PartyLogo
        partyName={votedNo[index]?.party}
      />
      <a href='#' className='plaintext' onClick={() => onQueryMp(votedNo[index].id)}>
  ...
  const AbsentRow = ({ index, style }) => (
    <li className='divisionDetails__list-li' style={{ ...style, display: 'flex', alignItems: 'center', gap: 8 }}>
      ...
      />
      <a href='#' className='plaintext' onClick={() => onQueryMp(absent[index].id)}>
  ...
  return (
    <div className="divisionDetails">
      ...
      {division && (
        <div className="divisionDetails__title">

          <div className="divisionDetails__title-wrapper">
          ...
          <div className="divisionDetails__title-wrapper divisionDetails__title__date">
      ...
      <div className='divisionDetails__list__wrapper'>

        {showAye && (
          <div className='divisionDetails__list'>
            <h3>Voted Aye ({division.AyeCount})</h3>
        ...
        {showNo && (
          <div className='divisionDetails__list'>
            <h3>Voted No ({division.NoCount})</h3>
            <AutoSizer>
              {({ height, width }) => (
                <List                  
                  height={height}
        ...
        {showAbsent && (
          <div className='divisionDetails__list'>
            <h3>Absent ({division.NoVoteRecorded.length})</h3>
            <AutoSizer>
              {({ height, width }) => (
                <List                  
                  height={height}
